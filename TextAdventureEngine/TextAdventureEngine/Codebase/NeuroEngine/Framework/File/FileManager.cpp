...
//=====================================================================================
CString FileManager::GetWorkingDirectory( const CString & a_FilePath ) const
{
	if ( a_FilePath.Length() > 0 )
	{
		return m_WorkingDirectory + ( ( a_FilePath[ 0 ] == '/' || a_FilePath[ 0 ] == '\\' ) ? a_FilePath.SubString( 1, a_FilePath.Length() - 1 ) : a_FilePath );
	}
