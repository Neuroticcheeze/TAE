...
//=====================================================================================
void PageConsole::OnTextFieldSubmit( ViewTextField & a_ViewTextField )
{
	if ( &a_ViewTextField == m_ConsoleInput )
	{
		ConsoleManager::Instance().ProcessString( m_ConsoleInput->GetTextView().GetText().Get() );
		m_ConsoleInput->GetTextView().SetText( "" );
	}
}