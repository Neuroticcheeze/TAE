...
{
	slSetForeColor( m_LayerResults[ a_Layer ].r, m_LayerResults[ a_Layer ].g, m_LayerResults[ a_Layer ].b, m_LayerResults[ a_Layer ].a );
	slRectangleFill( Config::WINDOW_X >> 1, Config::WINDOW_Y >> 1, Config::WINDOW_X, Config::WINDOW_Y );
}