...
{
	if ( InputManager::Instance().GetKeyState( InputManager::Key::UP ) == InputManager::ButtonState::PRESSED )
	{
		SelectItem( GetSelectedItem() - 1 );
	}
	
	if ( InputManager::Instance().GetKeyState( InputManager::Key::DOWN ) == InputManager::ButtonState::PRESSED )
	{
		SelectItem( GetSelectedItem() + 1 );
	}

	if ( InputManager::Instance().GetKeyState( InputManager::Key::ENTER ) == InputManager::ButtonState::PRESSED )
	{
