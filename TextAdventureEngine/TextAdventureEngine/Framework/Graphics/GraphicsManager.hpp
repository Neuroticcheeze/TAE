...
public:
	...
	TextureAtlas LoadTextureAsAtlas( uint32_t a_HashName, const char * a_Path, const Vector2 & a_SpritesPerAxis );
...
private:
	...
	Colour m_Colour[ ColourUsage::_NUM ];
...
#define _GetSpriteSheet( HASHNAME ) GraphicsManager::Instance().GetAtlas( WSID( HASHNAME ) )
