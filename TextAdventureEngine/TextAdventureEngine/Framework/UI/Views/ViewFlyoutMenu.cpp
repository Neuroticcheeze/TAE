...
{
	SendMessageUpward( WSID( "HOVER_BEGIN" ) );
...
{
	SendMessageUpward( WSID( "HOVER_END" ) );
...
{
	if ( WSID( "HOVER_BEGIN" ) == a_Message )
	{
		++m_HideProhibitorCounter;
	}

	else if ( WSID( "HOVER_END" ) == a_Message && m_HideProhibitorCounter > 0 )
	{
		--m_HideProhibitorCounter;
	}
